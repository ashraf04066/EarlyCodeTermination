...
def count_methods_with_asserts(file_path):
    ...
    for match in method_matches:
        ...
        if method_end != -1:
            ...
            asserts = re.findall(r"assert[A-Za-z]*\(", method_code)
            if len(asserts) > 1:
                count += 1
...
def main():
    #root_dir = 'E:/Projects/data mining/fault_localization_bias/testing-defects4j/lang/lang/lang_50%' 
    root_dir = 'E:/Projects/data mining/fault_localization_bias/testing-defects4j/math/104/math_104_buggy/src/test'  # Update this path to the root directory containing your Java files
    total_count = 0
